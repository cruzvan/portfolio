...
const AboutView: React.FC<AboutViewProps> = ({ onClose }) => {
  ...
  const socialLinks = [
    ...
    { icon: <Linkedin size={24} />, label: 'LinkedIn', href: 'https://www.linkedin.com/in/angelocruz' },
    { icon: <Github size={24} />, label: 'GitHub', href: 'https://github.com/angelocruzdev' },
    { icon: <BrainCircuit size={24} />, label: 'Web', href: 'https://www.my-company-website.com' }
  ];
